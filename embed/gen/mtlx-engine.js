...
const sceneTextureFastPathEnabled=()=>{try{return localStorage.getItem('mtlx_scene_texture_fast')!=='0';}catch(e){return true;}};// Scene snapshots can contain many UDIM tiles.  When a caller supplies a
