...
const factoryPromise=import('./js/materialx/'+ver+'/JsMaterialXGenShader.js').then(mod=>typeof mod.default==='function'?mod.default:loadMxFactoryViaScript(ver));mxEnvPromises.set(ver,factoryPromise.then(factory=>factory({// .wasm and .data live next to the .js.
