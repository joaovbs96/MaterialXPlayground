...
function RecSegRow({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "mtlx-rec-row"
  }, /*#__PURE__*/React.createElement("span", {
    className: "mtlx-rec-label"
  }, label), /*#__PURE__*/React.createElement("div", {
    className: "mtlx-rec-seg"
...
const RecordGifDialog = ({
  ...
  React.useEffect(() => {
    try {
      localStorage.setItem(RECORD_GIF_KEY, JSON.stringify(settings));
    } catch (e) {/* ignore */}
  }, [settings]);
  ...
  const canRecord = !!(view && typeof view.beginCapture === 'function' && typeof view.getCamera === 'function' && view.getCamera());
  const setField = key => value => setSettings(s => Object.assign({}, s, {
    [key]: value
  }));
  ...
  const frameCount = window.turntableFrameCount ? window.turntableFrameCount(settings.duration, settings.fps) : Math.round(settings.duration * settings.fps);
  ...
  const progressText = progress.phase === 'capture' ? `Capturing frame ${progress.done}/${progress.total}` : 'Encoding…';
  return /*#__PURE__*/React.createElement("div", {
    className: "mtlx-rec-overlay",
    onMouseDown: handleClose
  }, /*#__PURE__*/React.createElement("div", {
    className: "mtlx-rec-panel",
    onMouseDown: e => e.stopPropagation()
  }, /*#__PURE__*/React.createElement("div", {
    className: "mtlx-rec-header"
  }, /*#__PURE__*/React.createElement("span", {
    className: "mtlx-rec-title"
  }, "Record 360\xB0 GIF"), /*#__PURE__*/React.createElement("button", {
    className: "mtlx-rec-close",
    onClick: handleClose,
    title: "Close"
  }, /*#__PURE__*/React.createElement(MtlxIcon, {
    name: "x",
    className: "mtlx-rec-icon"
  }))), /*#__PURE__*/React.createElement("div", {
    className: "mtlx-rec-body"
  }, !canRecord && /*#__PURE__*/React.createElement("div", {
    className: "mtlx-rec-error"
  }, "Recording needs an orbit camera view."), /*#__PURE__*/React.createElement(RecSegRow, {
    label: "Size",
    value: settings.size,
    disabled: recording,
    onChange: setField('size'),
    options: [480, 720, 1080].map(v => ({
      value: v,
      label: String(v)
    }))
    ...
    className: "mtlx-rec-progress-fill",
    style: {
      width: pct + '%'
    }
  })), /*#__PURE__*/React.createElement("div", {
    className: "mtlx-rec-progress-text"
  }, progressText), /*#__PURE__*/React.createElement("canvas", {
    ref: previewRef,
    className: "mtlx-rec-preview"
  })), state === 'error' && /*#__PURE__*/React.createElement("div", {
    className: "mtlx-rec-error"
  }, error), state === 'done' && savedMB && /*#__PURE__*/React.createElement("div", {
    className: "mtlx-rec-success"
  }, "Saved ", savedMB, " MB")), /*#__PURE__*/React.createElement("div", {
    className: "mtlx-rec-footer"
  }, /*#__PURE__*/React.createElement("button", {
    className: "mtlx-rec-btn",
    onClick: handleClose
...
const DisplacementSettingsRows = () => {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Displacement"), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      const next = !enabled;
      setEnabled(next);
    ...
    className: `h-5 px-2 rounded border transition-colors shrink-0 ${enabled ? 'bg-blue-600/80 border-blue-500 text-white' : 'bg-gray-800/80 border-gray-600 text-gray-300'}`
  }, enabled ? 'On' : 'Off')), /*#__PURE__*/React.createElement("div", {
...
function SettingsDialog({
  ...
  return ReactDOM.createPortal(/*#__PURE__*/React.createElement("div", {
    ...
    className: "mt-1 text-[11px] text-gray-400"
  }, "Render opacity/transmission with real alpha blending in previews. When off, previews match the standard MaterialX viewer (opaque). Applies immediately to open previews.")), /*#__PURE__*/React.createElement(DisplacementSettingsRows, null), children)), fullscreenPortalRoot());
}
...
const looseFilesFrom = fileMap => {
  ...
  Object.keys(fileMap || {}).forEach(k => {
    if (window.isHiddenSideFile && window.isHiddenSideFile(k)) {
      skipped++;
      return;
    }
...
const MtlxSelect = ({
  ...
  const longestLabelPx = React.useMemo(() => {
    ...
    normalized.forEach(o => {
      if (!o.isFooter) max = Math.max(max, measureLabelWidth(o.label, font));
    });
  ...
  const popFitWidth = Math.min(Math.max(longestLabelPx + selectRowChromePx(hasRowIcon, hasDot, hasBadge), badges ? 240 : SELECT_POP_W), SELECT_POP_MAX_PX, Math.max(0, window.innerWidth - 16));
  ...
  const triggerClassName = [chrome, 'inline-flex items-center gap-1', block && 'w-full' + (alignLeft ? '' : ' justify-between'), fontCls, disabled && 'opacity-50 pointer-events-none', className].filter(Boolean).join(' ');
  ...
  const popStyle = Object.assign({
    position: 'fixed',
    zIndex: 9999,
    width: pos ? pos.width : popPreMeasureWidth,
