...
const panelGridStyle = () => ({
  backgroundImage: 'linear-gradient(to bottom, rgba(17,24,39,0) 0px, rgba(17,24,39,1) 360px), ' + 'linear-gradient(to right, rgba(107,114,128,0.16) 1px, transparent 1px), ' + 'linear-gradient(to bottom, rgba(107,114,128,0.16) 1px, transparent 1px)',
