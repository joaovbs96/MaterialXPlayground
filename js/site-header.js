...
(function () {
    ...
    // Given the current hash, which shell view is active? Mirrors
    // shell.jsx's parseHash: viewer/graph hash routes select those views,
    // '#!docs' or any hash starting with '#/' (legacy docs permalinks)
    // means docs, and everything else (empty, '#', '#!home') means home.
