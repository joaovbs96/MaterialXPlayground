            ...
            return (
                ...
                <div className={(embed ? 'flex flex-col md:flex-row gap-4' : 'flex flex-col lg:flex-row gap-4') + (suppressed ? ' hidden' : '')}>
                    ...
                    >
                        ...
                        {/* Always rendered (regardless of compact/fullscreen)
                            so both geometry dropdowns' footer action can
                            open it by ref. */}
                        <input
                            ref={modelInputRef}
                            type="file"
