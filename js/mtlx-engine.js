...
const createRgbtPeelPipeline = (renderer, {
    ...
    const free = () => {
        ...
        [resources.opaque, resources.layerC0, resources.layerC1, resources.layerT,
            ...
            resources.t0, resources.t1, resources.bloomA, resources.bloomB].forEach(disposeTarget);
        ...
        [resources.initMat, resources.updateCMat, resources.updateTMat,
            ...
            resources.bloomExtractMat, resources.bloomBlurMat].forEach((m) => { if (m) m.dispose(); });
    ...
    const alloc = (w, h) => {
        ...
        const bloomExtractMat = new THREE.RawShaderMaterial({
            ...
            uniforms: {
                ...
                u_threshold: { value: 1 }, u_knee: { value: 0.5 },
            },
        ...
        const bloomBlurMat = new THREE.RawShaderMaterial({
            ...
            fragmentShader:
                ...
                'o=vec4(sum,1.0);}\n',
            uniforms: { u_src: { value: null }, u_step: { value: new THREE.Vector2() } },
            blending: THREE.NoBlending, depthTest: false, depthWrite: false,
        });
        ...
        resources = { w, h, opaque, layerC0, layerC1, layerT, tail, c0, c1, t0, t1,
            ...
            bloomA, bloomB, bloomExtractMat, bloomBlurMat, bloomW, bloomH, bloomBlack };
...
const createPeelPipeline = (renderer, { getDisplayTransform: getDisplayTransformOpt, getDisplayExposure: getDisplayExposureOpt, linearComposite, opaqueOutput, layers, sceneRgbt = false, getBloom } = {}) => {
