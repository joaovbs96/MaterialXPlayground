...
const HOME_CARDS = [
    ...
    { id: 'scene', group: 'tools', href: '#!scene', icon: 'cube', title: 'Scene Viewer', badge: 'Experimental', desc: 'Drop a USD stage with MaterialX materials and render the whole scene: stage lights, shadows, ambient occlusion, reflections, and a double-click material preview.', img: 'images/preview-scene.jpg', cta: 'Open Scene Viewer' },
...
const HOME_FEATURED = [
    ...
    { card: 'scene', kicker: 'New: render a whole USD scene' },
