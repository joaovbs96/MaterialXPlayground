...
const HOME_CARDS = [
    ...
    { id: 'scene', group: 'tools', href: '#!scene', icon: 'cube', title: 'Scene Viewer', badge: 'Experimental', desc: 'Load a USD stage with its MaterialX materials, lights, and cameras, and render the whole scene in real time with shadows and occlusion.', img: 'images/preview-scene.jpg', cta: 'Open Scene Viewer' },
